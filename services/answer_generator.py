...
#                         {
#                             'url': "https://tds.s-anand.net/#/2025-01",
#                             'text': "TDS Evaluation Schedule"
#                         },
#                         {
#                             'url': "https://discourse.onlinedegree.iitm.ac.in",
#                             'text': "TDS Course Announcements"
#                         }
#                     ]
#                 }
#             },
...
#                             'text': "Score Reset Issue Discussion"
#                         }
#                     ]
#                 }
#             },
...
#                             'text': "GitHub Email Requirements Discussion"
#                         }
#                     ]
#                 }
#             },
...
#                             'text': "GA4 Dashboard Scoring Discussion"
#                         }
#                     ]
#                 }
#             }
...
#                     {
#                         'url': "https://tds.s-anand.net",
#                         'text': "TDS Course Schedule"
#                     },
#                     {
#                         'url': "https://discourse.onlinedegree.iitm.ac.in",
#                         'text': "TDS Announcements"
#                     }
#                 ]
#             }
...
#             # Check text and summary
#             text_text = post_topic.get('text', '').lower()
#             summary_text = post_topic.get('answer_summary', '').lower()
#             keywords_text = ' '.join(post_topic.get('keywords', [])).lower()
            
#             search_text = f"{text_text} {summary_text} {keywords_text}"
...
#                     'text': course_data.get('text', 'TDS Course Content')
#                 })
...
#                     'text': discourse_data.get('text', 'Discourse Discussion')
#                 })
